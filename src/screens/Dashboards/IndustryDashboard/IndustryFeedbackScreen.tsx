...
const styles = StyleSheet.create({
  ...
  policyBanner: { flexDirection: 'row', alignItems: 'flex-start', gap: 12, backgroundColor: '#E6F5F8', padding: 16, borderRadius: 16, borderWidth: 1, borderColor: '#CCEBEF', marginBottom: 24 },
  lockIconBox: { width: 40, height: 40, backgroundColor: '#FFF', borderRadius: 12, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#CCEBEF' },
  policyText: { flex: 1, fontSize: 13, color: '#475569', lineHeight: 20, fontWeight: '500' },
  policyBoldText: { color: '#0A8099', fontWeight: '800' },

  statsRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 4, marginBottom: 24 },

  insightsCard: { backgroundColor: '#E6F5F8', borderRadius: 20, padding: 20, borderWidth: 1, borderColor: '#CCEBEF', marginBottom: 24 },
  insightsHeader: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 16 },
  insightIconBox: { width: 32, height: 32, backgroundColor: '#0A8099', borderRadius: 10, alignItems: 'center', justifyContent: 'center', shadowColor: '#0A8099', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.3, shadowRadius: 4 },
  insightsTitle: { fontSize: 12, fontWeight: '800', color: '#0A8099', textTransform: 'uppercase', letterSpacing: 1 },
  insightsList: { gap: 12 },
