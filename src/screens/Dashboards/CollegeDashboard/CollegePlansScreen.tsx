...
async function handleSelectPlan(
  ...
  try {
    ...
    console.log("Proceeding to payment URL on mobile for college:", proceedPaymentUrl);
  ...
  const cards = [
    {
      ...
      icon: <Crown size={16} color="#059669" />,
      borderColor: '#A7F3D0',
      bgColor: '#ECFDF5',
    },
    {
    ...
    },
    {
      ...
      icon: <ShoppingBag size={16} color="#059669" />,
      borderColor: '#A7F3D0',
      bgColor: '#ECFDF5',
    },
  ];
  ...
  const fetchData = async () => {
    ...
    try {
      const [packagesRes, dashboardRes] = await Promise.allSettled([
        getBillingPackagesByType("College"),
        getUserSubscriptionDashboard(),
      ]);
    ...
    <SafeAreaView style={styles.safeArea} edges={['bottom']}>
      <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Animated.View entering={FadeInUp.delay(100)} style={styles.header}>
          ...
          <Text style={styles.subtitle}>Manage your institution's subscription</Text>
        </Animated.View>
          ...
          <View style={{ marginBottom: 24 }}>
            <Animated.View entering={FadeInUp.delay(200)}>
              ...
              <Text style={styles.chooseSubtitle}>
                Select a plan that best suits you. All plans include access to the College dashboard.
              </Text>
            </Animated.View>
                  ...
                  >
                    ...
                    <View style={styles.metaBadgeRow}>
                      ...
                      {plan.app_name ? (
                        <View style={[styles.pillBadge, { backgroundColor: '#ECFDF5', borderColor: '#A7F3D0' }]}>
                          <Text style={[styles.pillBadgeText, { color: '#047857' }]}>{plan.app_name}</Text>
                        </View>
                      ) : null}
                    </View>
                    ...
                    >
                      {redirectingPlan === plan.package_name ? (
                        <View style={styles.btnRow}>
                          <ActivityIndicator size="small" color={isPopular ? "#FFFFFF" : "#059669"} />
                          <Text style={[
                        ...
                        <View style={styles.btnRow}>
                          <Zap size={14} color={isPopular ? "#FFFFFF" : "#059669"} />
                          <Text style={[
                            styles.ctaButtonText, 
                            isPopular ? styles.ctaButtonTextPopular : styles.ctaButtonTextOutline,
                            { marginLeft: 6 }
...
const styles = StyleSheet.create({
  ...
  planCard: { backgroundColor: '#FFFFFF', borderRadius: 24, padding: 24, borderWidth: 1.5, borderColor: '#F1F5F9', borderLeftWidth: 4, borderLeftColor: '#059669', shadowColor: '#64748B', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.04, shadowRadius: 12, elevation: 3 },
  planCardPopular: { borderColor: '#A7F3D0', backgroundColor: '#ECFDF5', borderLeftColor: '#059669' },
  
  popularBadgeWrapper: { position: 'absolute', top: -10, left: 24, zIndex: 10 },
  popularBadge: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: '#059669', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, shadowColor: '#059669', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.3, shadowRadius: 4 },
  ...
  ctaButtonPopular: { backgroundColor: '#059669', shadowColor: '#059669', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 8 },
  ...
  ctaButtonTextOutline: { color: '#059669' },
  ...
  tryAgainButton: { backgroundColor: '#059669', paddingHorizontal: 20, paddingVertical: 10, borderRadius: 8 },
  ...
  stripActive: { backgroundColor: '#059669' },
  ...
  activeStatusBadge: { backgroundColor: '#059669', paddingHorizontal: 6, paddingVertical: 1, borderRadius: 4 },
  ...
  showMoreBtn: { marginTop: 12, width: '100%', backgroundColor: '#ECFDF5', borderWidth: 1, borderColor: '#A7F3D0', borderRadius: 12, paddingVertical: 10, justifyContent: 'center', alignItems: 'center' },
  showMoreBtnText: { fontSize: 11, fontWeight: '700', color: '#059669' },
