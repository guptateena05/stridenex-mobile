...
export const StudentPathScreen = () => {
  ...
  const handleGetCertificate = async () => {
    try {
      ...
      const rawUrl = `https://devstridenex.quantcloud.in/api/method/stridenex_app.api_stridenex_app.app.get_certificate?student_name=${encodeURIComponent(studentEmail)}&assessment_name=${encodeURIComponent(assessmentName)}&sr_no=1&email_id=${encodeURIComponent(studentEmail)}`;
