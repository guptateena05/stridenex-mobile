...
export const MentorOnboardingScreen = () => {
  const navigation = useNavigation<any>();

  return (
    <AnimatedAuthLayout
      title="Mentor Onboarding"
      subtitle="Set up your mentorship profile and availability"
    >
      <View style={styles.formContainer}>
        <Text style={styles.infoText}>Welcome! In a full implementation, you'd complete your expertise tags, availability schedules, and payout options here.</Text>
